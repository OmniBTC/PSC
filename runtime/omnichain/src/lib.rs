...
//! # OmniChain Runtime
//!
//! OmniChain is a parachain that provides an interface to create, manage, and use assets.
//! Assets are fungible.
//!
//! ## Assets
//!
...
//! ### Native Balances
//!
//! OmniChain uses its parent DOT token as its native asset.
//!
//! ### Governance
//!
//! OmniChain Sudo
...
//! ### Collator Selection
//!
//! OmniChain uses `pallet-collator-selection`, a simple first-come-first-served registration
//! system where collators can reserve a small bond to join the block producer set. There is no
//! slashing.
//!
//! ### XCM
//!
//! OmniChain can also serve as a reserve location to other parachains for DOT as well
...
pub use omnichain_common as common;
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("omnichain"),
	impl_name: create_runtime_str!("omnichain"),
	authoring_version: 1,
	spec_version: 1,
	impl_version: 0,
...
impl_runtime_apis! {
	...
	impl frame_try_runtime::TryRuntime<Block> for Runtime {
		fn on_runtime_upgrade() -> (Weight, Weight) {
			log::info!("try-runtime::on_runtime_upgrade omnichain.");
		...
		fn execute_block(block: Block, state_root_check: bool, select: frame_try_runtime::TryStateSelect) -> Weight {
			log::info!(
				target: "runtime::omnichain", "try-runtime: executing block #{} ({:?}) / root checks: {:?} / sanity-checks: {:?}",
				block.header.number,
				block.header.hash(),
				state_root_check,
				select,
